...
vignette: >
  %\VignetteIndexEntry{microHaplot introduction}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

This vignette concerns itself with an overview of microhaplot and on 
preparation of data for input into microhaplot Once your data has been transfered to the appropriate Haplot folder, see the `haPLOT walkthrough` vignette to learn more about microhaplot's graphical features.
