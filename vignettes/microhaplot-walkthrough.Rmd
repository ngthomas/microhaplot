...
options (minimum read depth and minimal allelic balance) there are four haplotypes in total discovered.
...
a histogram of read depths and allele balance ratios for reads assigned to each individuals, and it shows
