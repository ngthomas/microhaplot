...
data in microhaplot.  That will help a lot.
  ...
  The output of each is self-explanatory with a little exploration. This can be very useful when you want to dig into the nitty-gritty details of the short read data.
