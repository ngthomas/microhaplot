...
preparation of data for input into microhaplot Once your data has been transfered to the appropriate Haplot folder, see the `microhaplot walkthrough` vignette to learn more about microhaplot's graphical features.
