...
self-explanatory.  There is not a scale, but if you click in the center of any of genotypes with 
observed (non-zero) counts, you will be told (in the upper left of the figure) what the expected and
observed numbers were for that genotype.  These plots are not meant to provide a stringest test
...
expressing haplotype frequencies in the different groups.  
